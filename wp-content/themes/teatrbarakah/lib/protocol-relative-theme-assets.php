...
if ( ! class_exists( 'Teatrbarakah_Protocol_Relative_Theme_Assets' ) ) :

	/**
	 * Teatrbarakah_Protocol_Relative_Theme_Assets class
	 */
	class Teatrbarakah_Protocol_Relative_Theme_Assets {
		/**
	...
	$teatrbarakah_protocol_relative_theme_assets = new Teatrbarakah_Protocol_Relative_Theme_Assets();
endif;
