...
/******/ 	__webpack_require__.p = "/wp-content/themes/teatrbarakah/dist/";
/******/
...
jQuery(document).ready(function () {
  ...
  $(window).resize(function () {
    if ($($('.btn-burger').length >= 1)) {
      var top = $('.btn-burger').position();
      var left = $('.btn-burger').position();
      $('.menu-main-menu-container').css({
        top: left.top,
        left: top.left
      });
