...
if ( ! function_exists( 'teatrbarakah_theme_support' ) ) :
	/**
	 * Add theme supports
	 */
	function teatrbarakah_theme_support() {
		// Add language support: @link {https://codex.wordpress.org/Multilingual_WordPress}
		load_theme_textdomain( 'teatrbarakah', get_template_directory() . '/languages' );
	...
	add_action( 'after_setup_theme', 'teatrbarakah_theme_support' );
endif;
